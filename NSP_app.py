...
def build_model(input_data):
    ...
    This app allows you to predict the bioactivity towards inhibting the `Dengue NSP proteina` enzyme. `NSP` is a drug target for Alzheimer's disease.
    **Credits**
    ...
    with st.sidebar.header('1. Upload your CSV data'):
        ...
        st.sidebar.markdown("""
    [Example input file](https://raw.git)
    """)
